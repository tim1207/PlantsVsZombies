...
namespace game_framework
{
	...
	Card::Card(int a) {
		...
		// 設定卡片的等待時間和價錢
		switch (ID) {
		case 1:delay = 33 * 5;	price = 50;	 break;
		case 2:delay = 33 * 5;	price = 100; break;
		case 3:delay = 33 * 10;	price = 50;	 break;
	...
	void Card::LoadPlant() {
		switch (ID) {
		case 1:	plant.LoadBitmap("./RES/Plants/SunFlower/SunFlower_00.bmp", RGB(0, 0, 0));  	break;
		case 2: plant.LoadBitmap("./RES/Plants/PeaShooter/PeaShooter_00.bmp", RGB(0, 0, 0));  break;
		case 3: plant.LoadBitmap("./RES/Plants/WallNut/WallNut_00.bmp", RGB(0, 0, 0));	    	break;

...
namespace game_framework {
	...
	void CPractice::LoadBitmap() {
		...
		//或pic.LoadBitmap("Bitmapsl(Tortoise.bmp");
	}
	...
	void CGameStateRun::OnBeginState()
	{
		...
		peacard.SetTopLeft(-480, 50);
		sunflowercard.SetTopLeft(-480, 100);
		wallnutcard.SetTopLeft(-480, 150);
		zombiesone[0].SetTopLeft(640, 150);
		zombiesone[1].SetTopLeft(660, 180);
		zombiesone[2].SetTopLeft(640, 210);
		zombiesone[3].SetTopLeft(660, 240);
		zombiesone[4].SetTopLeft(640, 270);
...
//卡片部分
		if (peacard.Left() < 20)
			peacard.SetTopLeft(peacard.Left() + 10, 50);
		if (sunflowercard.Left() < 20)
			sunflowercard.SetTopLeft(sunflowercard.Left() + 10, 110);
...
//
		...
		for (int i = 0; i < 5; i++) {
			if (zombiesone[i].Left() < 1040)
				zombiesone[i].SetTopLeft(zombiesone[i].Left() + 10, 150 + i * 30);
		}
	...
	void CGameStateRun::OnInit()          // 遊戲的初值及圖形設定
	{
		...
		*/
		...
		//
		//practice.LoadBitmap("Bitmaps/Tortoise.bmp");
		border.LoadBitmap("Bitmaps/border.bmp", RGB(255, 255, 255));//ID no anser
		practice.LoadBitmap("Bitmaps/Tortoise.bmp");
		...
		help.LoadBitmap(Adventure);    // 載入說明的圖形
	...
	void CGameStateRun::OnShow()
	{
		...
		corner.ShowBitmap();
		border.ShowBitmap();
		practice.ShowBitmap(); //practice 2 
		c_practice.OnShow(); // practice 4
		*/
	}
